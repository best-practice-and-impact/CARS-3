...
In response to “In your current role, how often do you write code to complete your work objectives?” most respondents said they code "regularly" or "all the time".
...
When asked what data operations they do in their work, and whether they use code to do them. For each of the data operations the majority response was “I do some or all of this by coding”. The data operation with the highest frequency done without code is visualisation. 
...
The three highest access coding tools are all open source; R, SQL and Python. With 88.5% responses having access to R. 
...
The three most commonly known coding tools are all open source; R, SQL and python respectively. 
...
We calculated the number of respondents who have "access but no knowledge", "access and knowledge" and "knowledge but no access" for each programming tool. The tool with the greatest access only was Python and the tool with the greatest access and knowledge was R. The non-open source tool with the greatest access and knowledge is VBA.
