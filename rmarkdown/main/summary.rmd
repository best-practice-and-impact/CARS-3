...
People who write code to achieve their work objectives more often are more likely to report an improvement to their coding abilities. Conversely, those who do not code in their work are much more likely to report their coding abilities are getting worse. Although this finding is not surprising, it highlights the fact that analysts' coding abilities are not static, and need to be maintained. 
