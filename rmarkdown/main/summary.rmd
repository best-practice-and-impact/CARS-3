...
``` {r}
## Change in capability by code frequency
...
```{r}
#Advanced RAP TO IMPLEMENTATION
plot <- carsurvey3::plot_stacked(tables$adv_score_by_implementation , "Percent", "I Currently Implement RAP", sum(data$heard_of_RAP == "Yes" & data$code_freq != "Never"), colour_scale = "2gradients", neutral_mid = FALSE, font_size = 14, width = 600, height = 500)

table <- kableExtra::kable_styling(knitr::kable(tables$adv_score_by_implementation)) %>% 
  kableExtra::add_footnote(paste0("Sample size = ", sum(data$heard_of_RAP == "Yes" & data$code_freq != "Never")))

carsurvey2::wrap_outputs("adv-by-imp", plot, table)
...
```{r}
#advanced RAP TO understanding 
plot <- carsurvey3::plot_stacked(tables$adv_score_by_understanding, "Percent", "I Understand Key concepts of RAP", sum(data$heard_of_RAP == "Yes" & data$code_freq != "Never"), colour_scale = "2gradients", neutral_mid = FALSE, font_size = 14, width = 600, height = 500)

table <- kableExtra::kable_styling(knitr::kable(tables$adv_score_by_understanding)) %>% 
  kableExtra::add_footnote(paste0("Sample size = ", sum(data$heard_of_RAP == "Yes" & data$code_freq != "Never")))

carsurvey2::wrap_outputs("adv-by-und", plot, table)
